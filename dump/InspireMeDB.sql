...
insert  into `countries_sights`(`sight_id`,`sight_label`,`country_code`,`img_url`,`description`,`userId`) values (72,'zsdas','cz','horses-desktop-background-fire-desktop.jpg','test2',6),(73,'Test sight','cz','mountains.jpg','test',6);
